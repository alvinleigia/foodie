...
The Next.js rule above is mandatory. Before making changes involving Next.js APIs, routing, layouts, server components, client components, server actions, metadata, caching, middleware, or config, inspect the relevant documentation in `node_modules/next/dist/docs/`.
...
Before changing routing, layouts, server components, client components, server actions, metadata, caching, middleware, or config, read the relevant documentation from `node_modules/next/dist/docs/`.
