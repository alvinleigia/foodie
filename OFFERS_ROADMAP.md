...
- Offers must never leak across companies, restaurants or locations.
...
- [ ] Support offer scopes: company, restaurant and location.
...
- [ ] Add Restaurant/Location Offers route for restaurant managers.
...
- [ ] Add start/end time rules using tenant location timezone.
...
- [ ] Add offer usage reports by company, restaurant and location.
...
- Minimum order value.
- Company, restaurant and location scope.
- Active/inactive.
- Date validity.
- Usage limit.
...
- [ ] Should company owners be allowed to create location-specific offers directly?
- [ ] Should restaurant managers create restaurant-wide offers or only location offers?
...
- [ ] Location-only coupon does not work on another location.
